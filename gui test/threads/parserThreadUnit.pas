...
begin
  ...
  // je¿eli podajemy z³¹ wartoœæ wtedy exit    --Si le damos el valor como un ³ ¹ salga
  if index >= length(FPacketQueue) then exit;
  //if index < 0 then exit;

  // przesuwamy wszystkie obiekty by móc skróciæ tablice --mover todos los objetos a ser capaz de acortar las juntas
