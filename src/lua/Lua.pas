...
type
  ...
  public
    ...
    function DoString(str: String): Integer; virtual;// load string and execute
    function getErrorText(): string; // returns the error text
...
procedure lua_Hook(L: lua_State; var ar: lua_Debug); cdecl;
var
  s: string;
begin
  //s := ar.name;
...
begin
  ...
  {lua_pushinteger( LuaInstance, 666 );
  lua_setglobal( LuaInstance, 'dupa' );
...
function TLua.getFile(Filename: String): string;
var
  strList: TStringList;
begin
